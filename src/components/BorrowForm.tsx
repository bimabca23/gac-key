            ...
            <Grid container spacing={1}>
              ...
              <Grid size={9}>
                <TextField
                  ...
                  onChange={(
                    e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>
                  ) => setBorrowReq({ ...borrowReq, passId: e.target.value })}
                />
              </Grid>
              <Grid size={3}>
                <Typography
              ...
              <Grid size={9}>
                <TextField
                  ...
                  onChange={(
                    e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>
                  ) => setBorrowReq({ ...borrowReq, purpose: e.target.value })}
                />
              </Grid>
              <Grid size={12}>
              ...
              <Grid size={9}>
                <Typography variant="body1">
                  :{" "}
                  {lastKey().id
                    ? lastKey().quantity.toString().concat(" Pcs")
                    : ""}
                </Typography>
              </Grid>
              <Grid size={3}>
